...
Channel.value(params.run_FeatureCounts_after_STAR).set{g_179_0_g253_125}
Channel.value(params.run_FeatureCounts_after_Hisat2).set{g_188_0_g252_125}
Channel.value(params.run_FeatureCounts_after_Tophat2).set{g_189_0_g254_125}
Channel.value(params.run_FeatureCounts_after_RSEM).set{g_203_0_g251_125}
Channel.value(params.run_FeatureCounts_after_Kallisto).set{g_225_0_g255_125}
Channel.value(params.mate).into{g_229_0_g_127;g_229_1_g247_3;g_229_0_g247_14;g_229_0_g248_36;g_229_0_g249_14;g_229_0_g250_26;g_229_1_g251_82;g_229_1_g251_95;g_229_0_g251_131;g_229_1_g251_133;g_229_1_g252_82;g_229_1_g252_95;g_229_0_g252_131;g_229_1_g252_133;g_229_1_g253_82;g_229_1_g253_95;g_229_0_g253_131;g_229_1_g253_133;g_229_1_g254_82;g_229_1_g254_95;g_229_0_g254_131;g_229_1_g254_133;g_229_1_g255_82;g_229_1_g255_95;g_229_0_g255_131;g_229_1_g255_133;g_229_1_g256_26;g_229_1_g256_30;g_229_1_g256_46;g_229_1_g257_11;g_229_1_g257_16;g_229_1_g257_18;g_229_1_g257_19;g_229_1_g257_20;g_229_1_g257_21;g_229_1_g257_24;g_229_1_g257_23;g_229_0_g257_28;g_229_0_g257_31;g_229_0_g264_31;g_229_1_g264_30}
if (params.reads){
Channel
...
output:
 file "${newNameFasta}"  into g245_21_genome00_g245_52, g245_21_genome01_g245_54
 file "${newNameGtf}"  into g245_21_gtfFile10_g245_53, g245_21_gtfFile10_g245_54
...
if [ ! -e "${params.genome_source}" ] ; then
	...
	cp ${params.genome_source} ${genomeName}
fi
...
if [ ! -e "${params.gtf_source}" ] ; then
	...
	elif [[ "${params.gtf_source}" =~ "http" ]]; then
...
output:
 ...
 file "*/${genome2}" optional true  into g245_54_genome10_g247_16, g245_54_genome10_g250_31, g245_54_genome10_g249_16, g245_54_genome10_g248_32, g245_54_genome10_g256_47, g245_54_genome10_g264_21
 ...
 file "*/${bed2}" optional true  into g245_54_bed31_g251_134, g245_54_bed31_g252_134, g245_54_bed31_g253_134, g245_54_bed31_g254_134, g245_54_bed31_g255_134
...
input:
 val run_featureCounts from g_225_0_g255_125
...
input:
 val run_featureCounts from g_189_0_g254_125
...
input:
 val run_featureCounts from g_179_0_g253_125
...
input:
 val run_featureCounts from g_188_0_g252_125
...
input:
 val run_featureCounts from g_203_0_g251_125
...
output:
 file "*/${commondb2}" optional true  into g256_43_commondb02_g256_46, g256_43_commondb05_g256_44, g256_43_commondb05_g256_45
 file "*/${bowtieIndex2}" optional true  into g256_43_bowtieIndex13_g256_46, g256_43_bowtieIndex12_g256_44, g256_43_bowtieIndex12_g256_45
 file "*/${bowtie2Index2}" optional true  into g256_43_bowtie2index24_g256_46, g256_43_bowtie2index23_g256_44, g256_43_bowtie2index23_g256_45
 file "*/${starIndex2}" optional true  into g256_43_starIndex35_g256_46, g256_43_starIndex34_g256_44, g256_43_starIndex34_g256_45
...
g_230_1_g257_28.set{g257_28_reads10_g257_18}
...
input:
 val mate from g_229_0_g257_28
 set val(name), file(reads) from g_230_1_g257_28
...
echo "INFO: workflowWorkDir: \${workflowWorkDir}"
...
if [ -e "pipe.rsem.${name}/rsem.out.${name}.genome.bam" ] ; then
    ...
    samtools sort -o pipe.rsem.${name}/${name}.genome.bam pipe.rsem.${name}/rsem.out.${name}.genome.unsorted.bam
...
input:
 ...
 val paired from g_229_1_g251_133
...
input:
 val mate from g_229_0_g251_131
...
input:
 ...
 val paired from g_229_1_g255_133
...
input:
 val mate from g_229_0_g255_131
...
input:
 ...
 val paired from g_229_1_g252_133
...
input:
 val mate from g_229_0_g252_131
...
input:
 ...
 val paired from g_229_1_g254_133
...
input:
 val mate from g_229_0_g254_131
...
output:
 ...
 val sense_antisense  into g264_31_sense_antisense77
...
output:
 set val(name),file(bam)  into g264_29_bam_file00_g_95, g264_29_bam_file00_g253_121, g264_29_bam_file01_g253_131, g264_29_bam_file00_g253_133, g264_29_bam_file00_g253_134, g264_29_bam_file00_g253_142
...
input:
 ...
 val paired from g_229_1_g253_133
...
input:
 val mate from g_229_0_g253_131
...
esat_parameters = params.ESAT.esat_parameters
esat_RAM = params.ESAT.esat_RAM
...
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /.*.(txt|log)$/) "ESAT/$filename"}
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /.*umi.distributions.txt$/) "ESAT/$filename"}
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /${namePrefix}_esat.log$/) "ESAT/$filename"}
input:
 set val(name), file(filtered_bam) from g264_29_bam_file00_g_95.transpose()

output:
 file "*.{txt,log}"  into g_95_outputFileTxt00
 set val(name), file("*umi.distributions.txt") optional true  into g_95_UMI_distributions11
 set val(name), file("${namePrefix}_esat.log")  into g_95_log_file22
